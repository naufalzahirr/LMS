...
class UpdateLessonRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'file' => $richContent ? ['prohibited'] : $this->fileRules($lessonType, $requiresFile),
    ...
    public function payload(): array
    {
        return [
            ...
            'lesson_type' => LessonType::tryFrom($this->string('lesson_type')->toString()) ?? $this->lesson()->lesson_type,
