...
class UpdateProgramRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('update', $this->program()) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['required', 'string', 'max:255', 'alpha_dash:ascii', Rule::unique(Program::class)->ignore($program)],
            'code' => ['nullable', 'string', 'max:50', Rule::unique(Program::class)->ignore($program)],
