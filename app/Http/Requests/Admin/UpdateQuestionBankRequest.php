...
class UpdateQuestionBankRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $course instanceof Course
            && $this->user()->can('update', $this->questionBank())
            && $this->user()->can('create', [QuestionBank::class, $course]);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => ['nullable', 'string', 'max:50', Rule::unique(QuestionBank::class)->where('course_id', $courseId)->ignore($this->questionBank())],
    ...
    private function questionBank(): QuestionBank
    {
        $questionBank = $this->route('questionBank');
        abort_unless($questionBank instanceof QuestionBank, 404);
