...
class StoreCompetencyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => ['required', 'string', 'max:50', Rule::unique(Competency::class)->where('course_id', $courseId)],
            'name' => ['required', 'string', 'max:255'],
            'slug' => ['required', 'string', 'max:255', 'alpha_dash:ascii', Rule::unique(Competency::class)->where('course_id', $courseId)],
