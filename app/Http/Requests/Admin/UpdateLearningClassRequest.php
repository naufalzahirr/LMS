...
class UpdateLearningClassRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('update', $this->learningClass()) ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => ['required', 'string', 'max:50', 'alpha_dash:ascii', Rule::unique(LearningClass::class)->ignore($this->learningClass())],
