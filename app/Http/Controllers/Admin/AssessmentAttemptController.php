...
class AssessmentAttemptController extends Controller
{
    ...
    public function index(
        ...
        return Inertia::render('assessment-attempts/Index', [
            ...$this->queries->listPayload($learningClass, $assignment, $status, 'admin.class-assessment-attempts.edit', $search),
            'backUrl' => route('admin.classes.show', $learningClass),
        ]);
    }
    ...
    public function edit(
        ...
        return Inertia::render('assessment-attempts/Grade', [
            ...
            'previousUrl' => $adjacent['previous_id'] !== null
                ? route('admin.class-assessment-attempts.edit', [$learningClass, $assignment, $adjacent['previous_id'], ...$filterQuery])
                : null,
            'nextUrl' => $adjacent['next_id'] !== null
                ? route('admin.class-assessment-attempts.edit', [$learningClass, $assignment, $adjacent['next_id'], ...$filterQuery])
                : null,
            'submitUrl' => route('admin.class-assessment-attempts.update', [$learningClass, $assignment, $attempt]),
            'backUrl' => route('admin.class-assessment-attempts.index', [$learningClass, $assignment, ...$filterQuery]),
        ]);
    }
