...
class AssessmentAttemptController extends Controller
{
    ...
    public function index(
        ...
        return Inertia::render('assessment-attempts/Index', [
            ...$this->queries->listPayload($learningClass, $assignment, $status, 'admin.class-assessment-attempts.edit'),
    ...
    public function edit(
        ...
        return Inertia::render('assessment-attempts/Grade', [
            ...
            'backUrl' => route('admin.class-assessment-attempts.index', [$learningClass, $assignment]),
        ]);
    }
